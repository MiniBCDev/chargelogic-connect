 ...
 */
class CheckTransactionsController extends BaseController
{
    /**
     * @var CheckTransactionsController The reference to *Singleton* instance of this class
     */
    private static $instance;

    /**
     * Returns the *Singleton* instance of this class.
     * @return CheckTransactionsController The *Singleton* instance.
     */
     ...
     *
     * @param Models\CheckTransactionModel $checkTransaction  TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createCheckCharge(
        $checkTransaction
    ) {

        //prepare query string for API call
        $_queryBuilder = '/CheckCharge';
        ...
        //json encode body
        $_bodyJson = Request\Body::Json($checkTransaction);
     ...
     *
     * @param Models\SetupHostedCheckTransactionModel $body TODO: type description here
     * @return mixed response from the API call
     * @throws APIException Thrown if API call fails
     */
    public function createSetupHostedCheckCharge(
        $body
    ) {

        //prepare query string for API call
        $_queryBuilder = '/SetupHostedCheckCharge';
