 ...
 */
class SetupHostedCheckTransactionModel implements JsonSerializable
{
    /**
    ...
    public function __construct()
    {
        if (6 == func_num_args()) {
            ...
            $this->identification  = func_get_arg(2);
            $this->billingAddress  = func_get_arg(3);
            $this->shippingAddress = func_get_arg(4);
            $this->hostedPayment   = func_get_arg(5);
        }
    }
